    ...
    <main>
      ...
      <div className="bg-black text-white p-2 flex flex-col md:flex-row items-center justify-between mb-12">
        <div className="md:w-1/2 space-y-4 md:pl-8">
          ...
          <h3 className="text-base" style={{ fontFamily: 'Open Sans, sans-serif' }}>Whether you’re newly diagnosed, supporting a loved one, or just wanting to learn more, we’re here to help you every step of the way.</h3>
        </div>
        <div className="md:w-1/2 mt-6 md:mt-0 aspect-[3/2] max-w-[700px] mx-auto">
          <img src="/images/homeimage.png" alt="Home Page Header Image" className="w-full h-full object-cover rounded-lg"/>
        </div>
      </div>
