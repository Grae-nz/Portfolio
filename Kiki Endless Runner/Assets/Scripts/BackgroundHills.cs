...
public class BackgroundHills : MonoBehaviour
{
    ...
    private void Update()
    {
        float speed = GameManager.Instance.gameSpeed * 0.001f; // Adjust the multiplier to control the speed relative to the ground
